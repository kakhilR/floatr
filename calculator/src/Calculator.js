    ...
    return (
        <Container maxWidth="sm" >
            ...
            <div style={{width:"500px",height:"100px",marginTop:"20px",display:"flex",justifyContent:"space-between",marginLeft:'-35px'}} className="result">
                        ...
                        <div style={{height:"50px",width:"150px", marginTop:"5px",backgroundColor:"#ffa726",borderRadius:"5px",textAlign:"center",fontFamily:'inter',color:"white"}}>{total}</div>

                 </div>
                 <div style={{width:"300px",height:"100px",marginTop:"20px",justifyContent:"space-between",marginLeft:'140px'}} className="result">
                        <div style={{height:"50px",width:"150px", marginTop:"5px",backgroundColor:"#ffa726",borderRadius:"5px",textAlign:"center",fontFamily:'inter',color:"white"}}>{payableInterest}</div>
                 </div>
        </Container>
    )
}
